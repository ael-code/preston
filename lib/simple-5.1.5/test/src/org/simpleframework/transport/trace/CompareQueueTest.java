...
public class CompareQueueTest extends TestCase {
   ...
   private final Executor blockingReadExecutor = new PoolExecutor(BlockingConsumer.class, THREAD_COUNT);
   private final Executor concurrentReadExecutor = new PoolExecutor(ConcurrentConsumer.class, THREAD_COUNT);
   private final Executor writeExecutor = new PoolExecutor(Producer.class, THREAD_COUNT);
